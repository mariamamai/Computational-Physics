...
#η πιο συνχή διεύθυνση ανέμου στην στήλη DIR. Η τιμή φαίνεται στην ένδειξη top
df['DIR'].describe()
print(df['DIR'].describe())
#top         N
print('\nΤις περισσότερες μέρες του χρόνου φυσσούσε από τον Βορρά')
...
#μου εμφανίζει AssertionError και δεν μπορώ να καταλάβω γιατί
#αν τρέξω την ίδια εντολή για το MONTH για παράδειγμα δουλεύει κανονικά
#από τα δεδομένα που θα προέκυπταν θα μπορύσα να δω ποια διεύθυνση ανέμου είχε και την μεγαλύτερη ένταση
